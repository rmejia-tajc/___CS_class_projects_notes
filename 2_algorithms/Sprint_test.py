class SortingRobot:
    ...
    #     # if you can't move right and the robot light is off...
    #     if self.can_move_right() == False and self.light_is_on() == False:
    #         #sorting is complete
    #         pass
    #     # if you can move right or the robot light is on...
    #     else:
    #         # turn off the robot's light
    #         self.set_light_off()
    #         # swap the robot's item with the item on the list at the current position
    #         self.swap_item()
    #         # while robot can move right...
    #         while self.can_move_right() == True:
    #             # move robot right to new position
    #             self.move_right()
    #             # compare the robot item with item in list at current position. if list item is greater than robot item...
    #             if self.compare_item() == 1:
    #                 # swap items
    #                 self.swap_item()
    #                 # turn robot light on
    #                 self.set_light_on()
    #         # while comparing items 
